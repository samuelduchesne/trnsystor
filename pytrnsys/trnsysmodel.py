...
from pytrnsys.anchorpoint import AnchorPoint
...
from pytrnsys.collections.specialcards import SpecialCardsCollection
from pytrnsys.component import Component
from pytrnsys.externalfile import ExternalFile
from pytrnsys.studio import StudioHeader
from pytrnsys.typecycle import TypeCycle
from pytrnsys.typevariable import (
    Derivative,
    Input,
    Output,
    Parameter,
...
from pytrnsys.specialcard import SpecialCard
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            externalFiles (pytrnsys.external_file.ExternalFileCollection): A
            class handling
