...
from pytrnsys import TrnsysModel, get_rgb_from_int
...
from pytrnsys.linkstyle import _studio_to_linestyle
from pytrnsys.name import Name
from pytrnsys.statement import (
    End,
    Version,
    Constant,
    Simulation,
...
from pytrnsys.trnsysmodel import (
    MetaData,
)
...
class Deck(object):
    ...
    def __init__(
        ...
        Args:
            ...
            models (list or pytrnsys.collections.components.ComponentCollection):
