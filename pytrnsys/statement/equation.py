...
from pytrnsys import TypeVariableSymbol, print_my_latex
from pytrnsys.statement.constant import Constant
from pytrnsys.statement.statement import Statement
from pytrnsys.typevariable import TypeVariable
...
class Equation(Statement, TypeVariable):
    ...
    Hint:
        In pytrnsys, the Equation class works hand in hand with the
    ...
    def from_symbolic_expression(cls, name, exp, *args, doc=None):
        ...
        Examples:
            ...
            >>> from pytrnsys.statement import Equation
